...
function numberLabel(documentTitle?: string) {
  if (documentTitle === "RECEIPT") {
    return "Receipt No.";
  }
...
export default function DocumentLetterhead({
  ...
  return (
    <header
      className={"document-letterhead w-full bg-white text-slate-900 " + className}
    >
      <div className="grid grid-cols-[78px_minmax(0,1fr)_172px] items-start gap-4">
        ...
        <div className="min-w-0 pt-1">
          ...
          <div className="mt-3 space-y-1 text-[9px] font-semibold leading-[1.35] text-slate-600">
            <p>Tujereng, West Coast Region, The Gambia</p>

            <p>
              <span className="font-bold text-slate-700">+220 789 3464</span>
              <span className="mx-1.5 text-slate-300">|</span>
              <span>eblasandson2@gmail.com</span>
            </p>
            ...
            <p>
              ...
              TikTok
              <span className="mx-1 text-slate-300">•</span>
              <span className="font-black text-[#17488f]">@DjallowsFarm</span>
            </p>
          </div>
        </div>
...
export function DocumentSignatureBlock({
  ...
  return (
    ...
    >
      ...
      <div>
        <div
          className="manager-electronic-signature h-[12mm]"
