...
export default function ExpensesPage() {
  ...
  const [
    editTobaskiLinked,
    setEditTobaskiLinked,
  ] = useState(false);

  const [
    editTobaskiSeasonId,
    setEditTobaskiSeasonId,
  ] = useState("");

  const [
    editTobaskiQuantity,
    setEditTobaskiQuantity,
  ] = useState("");
    ...
    async function loadExpenses() {
      try {
        ...
        if (
          ...
          throw new Error(
            `Unable to load expense records: ${transactionResult.error.message}`
          );
        }
        ...
        if (
          ...
          throw new Error(
            `Unable to load financial accounts: ${accountResult.error.message}`
          );
        }
  ...
  function toggleSelected(
    ...
    if (
      ...
      setNotification(
        "Payroll records are managed in Staff & Payroll"
      );
    ...
    setSelectedIds(
      (current) => {
        ...
        if (
          ...
          selectableTransactions.forEach(
            (
              transaction
            ) => {
              next.delete(
  ...
  async function saveEdit(
    ...
    if (
      ...
      if (
        ...
        setEditError(
          "Please enter the number of sheep purchased for this Tobaski expense."
        );
  ...
  async function deleteSelected() {
    ...
    const confirmed =
      window.confirm(
        `Delete ${ids.length} selected expense record${
          ids.length === 1
            ? ""
            : "s"
        }?\n\nThis action cannot be undone.`
  ...
  return (
    <FinancePageShell
      eyebrow="Money Out"
      title="Expenses"
      description="Track spending, control farm costs and understand exactly where every dalasi is going."
      actionHref="/expenses/new"
      actionLabel="Add Expense"
      recordText={`${filteredTransactions.length} expense records`}
    >
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <SummaryCard
          ...
          note="Based on the records currently shown"
          icon={
            <ReceiptText
              size={23}
            />
        ...
        <SummaryCard
          ...
          note="Number of expense transactions"
          icon={
            <FileText
              size={23}
            />
        ...
        <SummaryCard
          ...
          note="Average amount per record"
          icon={
            <CircleGauge
              size={23}
            />
        ...
        <SummaryCard
          ...
          value={
            money(
              tobaskiInvestmentShown
            )
          }
          note={
            tobaskiExpenseCount > 0
              ? `${tobaskiExpenseCount} linked expense record${
                  tobaskiExpenseCount ===
                  1
                    ? ""
                    : "s"
                }`
              : "No Tobaski expenses in the current view"
          }
          icon={
            <CalendarDays
              size={23}
      ...
      <section className="mt-5 overflow-hidden rounded-[24px] border border-white/90 bg-white/95 shadow-[0_12px_35px_rgba(15,23,42,0.07)]">
        ...
        <div className="flex flex-col gap-3 border-b border-slate-200 px-5 py-5 sm:flex-row sm:items-end sm:justify-between sm:px-6">
          ...
          <div>
            ...
            <h2 className="mt-1 text-[21px] font-bold text-slate-900">
              Find Expense Records
            </h2>

            <p className="mt-1 text-[15px] leading-6 text-slate-600">
              Search descriptions, categories, accounts, Tobaski seasons, notes or transaction numbers.
            </p>
        ...
        <div className="grid gap-3 p-5 sm:p-6 xl:grid-cols-[1.4fr_1fr_1fr_1fr]">
      ...
      <div className="mt-5 grid gap-5 xl:grid-cols-[1.55fr_0.85fr]">
        ...
        <section className="rounded-[24px] border border-white/90 bg-white/95 p-5 shadow-[0_12px_35px_rgba(15,23,42,0.07)] sm:p-6">
          ...
          <p className="mt-1 text-[15px] leading-6 text-slate-600">
            See which areas are taking the largest share of farm spending.
          </p>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="mb-2.5 flex items-center justify-between gap-4">
                          ...
                          <p className="shrink-0 text-[17px] font-bold text-[#0f172a]">
                            {money(
                              category.value
                            )}
                          </p>
        ...
        <section className="overflow-hidden rounded-[24px] bg-gradient-to-br from-[#0b5136] to-[#073523] text-white shadow-[0_16px_40px_rgba(13,61,42,0.20)]">
          ...
          <div className="divide-y divide-white/15">
            ...
            <QuickFact
              ...
              note="Most frequently used account for expenses"
            />
      ...
      <section className="mt-5 overflow-hidden rounded-[26px] border border-white/90 bg-white shadow-[0_16px_45px_rgba(15,23,42,0.08)]">
        ...
        <div className="flex flex-col gap-4 border-b border-slate-200 px-5 py-5 sm:px-6 xl:flex-row xl:items-center xl:justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-emerald-50 text-[#0d5138]">
            ...
            <div>
              ...
              <p className="mt-1 text-[14px] font-medium text-slate-600">
                Detailed history of farm spending
              </p>
                  ...
                  {isOwnerOrAdmin && (
                    <th className="px-5 py-4 text-center">
                      ...
                      <input
                        ...
                        aria-label="Select all visible expense records"
                      />
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-6 py-5 align-middle">
                          ...
                          {season ? (
                            <div>
                              ...
                              <span className="inline-flex whitespace-nowrap rounded-full border border-amber-300 bg-amber-50 px-3 py-1.5 text-[13px] font-bold text-amber-800">
                                {
                                  season.season_name
                                }
                              </span>
                        ...
                        <td className="px-6 py-5 text-right align-middle">
                          ...
                          <span className="inline-flex whitespace-nowrap rounded-lg bg-slate-100 px-3 py-2 text-[15px] font-bold text-slate-950">
                            -{" "}
                            {money(
                              transaction.amount
                            )}
              ...
              <div className="mt-6 rounded-2xl border border-amber-200 bg-amber-50 p-4 sm:p-5">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <input
                    ...
                    className="mt-1 h-5 w-5 cursor-pointer accent-[#0b5136]"
                  />

                  <div>

                    <label
                      htmlFor="edit-tobaski-linked"
                      className="cursor-pointer text-[15px] font-bold text-slate-900"
                    >
                      This expense is part of a Tobaski investment
                    </label>

                    <p className="mt-1 text-[13px] leading-5 text-slate-600">
                      The expense remains one normal expense record. Linking it here only allows the Tobaski report to include it in the selected season.
                    </p>
                    ...
                    {editIsSheepPurchase && (
                      <div>
                        ...
                        <input
                          ...
                          placeholder="e.g. 10"
                          className="w-full rounded-xl border border-amber-300 bg-white px-4 py-3.5 text-[15px] font-bold text-slate-900 outline-none focus:border-amber-500 focus:ring-4 focus:ring-amber-100"
                        />

                        <p className="mt-2 text-[12px] font-medium text-slate-600">
                          This quantity is used to calculate sheep bought and sheep remaining for the Tobaski season.
                        </p>
